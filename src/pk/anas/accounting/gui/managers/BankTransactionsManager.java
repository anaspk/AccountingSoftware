...
import pk.anas.accounting.dao.BankTransactionDAO;
import pk.anas.accounting.gui.forms.BankTransactionForm;
 ...
 */
public class BankTransactionsManager extends JPanel
{
    ...
    private BankTransactionForm editingForm;
    private JButton saveButton;
    private JButton updateButton;
    
    public BankTransactionsManager( ConnectionManager connectionManager )
    {
        super();
        bankTransactionDAO = new BankTransactionDAO( connectionManager );
        displayTableModel = new CustomTableModel( bankTransactionDAO.getDataForTableModel() );
        ...
        editingForm = new BankTransactionForm();
        ...
        addNew.addActionListener( new ActionListener()
            {
                ...
                public void actionPerformed( ActionEvent e )
                {
                    ...
                    BankTransactionsManager.this.revalidate();
                }
            }
        );
        toolBar.add( addNew );
